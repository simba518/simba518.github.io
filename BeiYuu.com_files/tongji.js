...
{
	var unit_id     = "2727758";
	var client_ip   = "122.228.95.10";
	var server_time = "1400667303";
	var verify_code = "9c71e328";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2727758/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
